...
pdf(paste0(dir_plot_path,"/Fig_rarefaction_wnv_q0_",suffix_for_plot,today,".pdf"), 
      width = 10, height = 10) 
...
pdf(paste0(dir_plot_path,"/Fig_rarefaction_mosq_q0",suffix_for_plot,today,".pdf"), 
      width = 10, height = 10) 
...
pdf(paste0(dir_plot_path,"/Fig_rarefaction_mosq_q1_",suffix_for_plot,today,".pdf"), 
      width = 10, height = 10) 
...
pdf(paste0(dir_plot_path,"/Fig_rarefaction_mosq_q2_",suffix_for_plot,today,".pdf"), 
      width = 10, height = 10) 
...
pdf(paste0(dir_plot_path,"/Fig_heat_wnv_mir",suffix_for_plot,today,".pdf"), 
      width = 12, height = 10) 
  p_heat_wnv_rel
dev.off()
...
pdf(paste0(dir_plot_path,"/Fig_heat_mosqAB_log",suffix_for_plot,today,".pdf"), 
      width = 12, height = 10) 
  p_heat
dev.off()
```
...
pdf(paste0(dir_plot_path,"/Fig_heat_wnvAB",suffix_for_plot,today,".pdf"), 
      width = 10, height = 10) 
  p_heat_wnv
dev.off()
...
pdf(file = paste0(dir_plot_path,"/corr_envs_kendall",suffix_for_plot,today,".pdf"),
                  width = 30, height = 30)
