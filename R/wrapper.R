...
knitr::knit(
  input = here::here("R", "Fig5_S1_communityMetrics_20260220.Rmd"),
...
if (FLAG_run == 1) {
  for (ii in 1:length(data_year_ct)) {
    ...
    ## the three scripts
    source(here::here("R", "Fig5_S1_communityMetrics_20260220.R"))
    source(here::here("R", "Fig6_bloodmealCorrelations_20260218.R"))
    source(here::here("R", "Fig7_S2_PCA_20260218.R"))
    source(here::here("R", "Fig7_S2_PCA_bloodmeal_20260224.R"))
  }
  print("done")
}
dev.off()
