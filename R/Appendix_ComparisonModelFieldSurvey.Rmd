...
pdf(
  file = paste0(
    dir_plot_path, "/Fig_SXa_histogram_",
...
pdf(
  file = paste0(
    dir_plot_path, "/Fig_SXb_zero_inflated_glm_",
    data_year, suffix_for_plot, today, ".pdf"
  ),
  width = 5, height = 5
)
...
pdf(
  file = paste0(
    dir_plot_path, "/Fig_SXb2_ggplot2_lm_",
    data_year, suffix_for_plot, today, ".pdf"
  ),
  width = 5, height = 5
)
...
pdf(
  file = paste0(
    dir_plot_path, "/Fig_SXc_random_effects_lmm_",
    data_year, suffix_for_plot, today, ".pdf"
  ),
  width = 7, height = 7
)
...
pdf(
  file = paste0(
    dir_plot_path, "/Fig_SXd_heatmap_",
    data_year, suffix_for_plot, today, ".pdf"
  ),
  width = 7, height = 10
)
